...
if (/export const WORK: WorkItem\[\] = \[\];/.test(content)) {
  add('blocker', 'Student work', 'The "Look what you\'ll create" gallery is empty, so it does not render. The whole design direction rests on it: the page sells the course by showing what students make.',
      'Put real student work in public/work/ and list it in WORK. Nothing here can be stock or generated by anyone but a student.');
}
